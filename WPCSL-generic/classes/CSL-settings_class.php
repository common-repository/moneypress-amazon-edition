...
class wpCSL_settings__mpamz {
            ...
            array(
			  ...
			  <div style="clear:left;">
                         ...
                         <div style="clear:left;">
                           ...
                           <div style="float: left;">' . WPCSL__mpamz__VERSION . '
                           </div>
                         </div>
                         <div style="clear:left;">
                           <div style="width:150px; float:left; text-align: right;
    ...
    function add_section($params) {
        $this->sections[$params['name']] = new wpCSL_settings_section__mpamz(
            array_merge(
                $params,
...
/****************************************************************************
 **
 ** class: wpCSL_settings_section__mpamz
 **
 **/
class wpCSL_settings_section__mpamz {
    ...
    function add_item($params) {
        $this->items[] = new wpCSL_settings_item__mpamz(
            array_merge(
                $params,
                array('plugin_url' => $this->plugin_url)
            )
...
/****************************************************************************
 **
 ** class: wpCSL_settings_item__mpamz
 **
