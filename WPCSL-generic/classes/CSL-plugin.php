...
define('WPCSL__mpamz__VERSION', '1.4.7');
...
class wpCSL_plugin__mpamz {
    ...
    function create_helper($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_helper__mpamz':
            case 'default':
            default:
                $this->helper = new wpCSL_helper__mpamz($this->helper_config);
    ...
    function create_notifications($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_notifications__mpamz':
            case 'default':
            default:
                $this->notifications = 
                    new wpCSL_notifications__mpamz($this->notifications_config);
        }
    }
    ...
    function create_products($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_products__mpamz':
            case 'default':
            default:
                $this->products = new wpCSL_products__mpamz($this->products_config);
    ...
    function create_settings($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_settings__mpamz':
            case 'default':
            default:
                $this->settings = new wpCSL_settings__mpamz($this->settings_config);
    ...
    function create_license($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_license__mpamz':
            case 'default':
            default:
                if (!$this->no_license) {
                    $this->license = new wpCSL_license__mpamz($this->license_config);
                }
    ...
    function create_cache($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_cache__mpamz':
            case 'default':
            default:
                $this->cache = new wpCSL_cache__mpamz($this->cache_config);
